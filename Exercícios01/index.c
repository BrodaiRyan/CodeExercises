...
int mediadegols02() {
    ...
    printf("A media de gols por partida eh de: %.2f", media);
...
int conversao03() {
    ...
    printf("O tempo de jogo foi de %dh %dmin.", hora, minuto);
...
int aproveitamento04() {
    ...
    printf("O rendimento total do time foi de: %d pontos.", victorie + tie);
